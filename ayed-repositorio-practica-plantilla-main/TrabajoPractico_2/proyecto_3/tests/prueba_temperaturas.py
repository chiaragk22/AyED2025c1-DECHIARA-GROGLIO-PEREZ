...
if __name__ == "__main__":
    ...
    print("\n== Temperatura máxima entre 05/04 y 15/04 ==")
    print("Máx:", db.max_temp_rango("05/04/2025", "15/04/2025"))
    print("\n== Temperatura mínima entre 05/04 y 15/04 ==")
    print("Min:", db.min_temp_rango("05/04/2025", "15/04/2025"))

    # 6) Borrar 08/04/2025 y volver a consultar
    db.borrar_temperatura("08/04/2025")
    print("\nDespués de borrar 08/04/2025 → cantidad:", db.cantidad_muestras())
